...
if __name__ == '__main__':
    ...
    torch.save(model.state_dict(), "checkpoints/vgg_a.pth")
    ...
    plt.xlabel('Epoch')
    plt.title('VGG_A Training')
    plt.legend()
    plt.savefig("outputs/vgg_a_curve.png")
    print("✅ 模型与图像已保存")
    ...
    plt.xlabel('Epoch')
    plt.title('VGG_A Loss Landscape')
    plt.legend()
    plt.savefig('outputs/vgg_a_landscape.png')
